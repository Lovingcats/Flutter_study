...
- [x] **Dart 언어 기초**
  - 동적 및 정적 타이핑의 차이 이해 [[Flutter] 정적타이핑 개발이란?](https://lovingcats.tistory.com/5)
  - 변수, 상수, 자료형 등의 기본 문법 학습 [[Flutter] 변수](https://lovingcats.tistory.com/6) [[Flutter] 연산](https://lovingcats.tistory.com/7)
  - 예제: 간단한 계산기 함수 작성
